...
describe 'compiled component sftp' do
  ...
  context "Resource" do
    ...
    context "adminSftpUserSecret" do
      ...
      it "to have property SecretString" do
          expect(resource["Properties"]["SecretString"]).to eq({"Fn::Sub"=>["{\"Role\":\"${Role}\",\"HomeDirectory\":\"/sftp.bucket/home/admin\",\"Policy\":\"{\\\"Version\\\":\\\"2012-10-17\\\",\\\"Statement\\\":[{\\\"Sid\\\":\\\"AllowListingOfUserFolder\\\",\\\"Action\\\":[\\\"s3:ListBucket\\\"],\\\"Effect\\\":\\\"Allow\\\",\\\"Resource\\\":[\\\"arn:aws:s3:::${!transfer:HomeBucket}\\\"],\\\"Condition\\\":{\\\"StringLike\\\":{\\\"s3:prefix\\\":[\\\"${!transfer:HomeFolder}/*\\\",\\\"${!transfer:HomeFolder}\\\"]}}},{\\\"Sid\\\":\\\"AWSTransferRequirements\\\",\\\"Effect\\\":\\\"Allow\\\",\\\"Action\\\":[\\\"s3:ListAllMyBuckets\\\",\\\"s3:GetBucketLocation\\\"],\\\"Resource\\\":\\\"*\\\"},{\\\"Sid\\\":\\\"HomeDirObjectGetAccess\\\",\\\"Effect\\\":\\\"Allow\\\",\\\"Action\\\":[\\\"s3:GetObject\\\",\\\"s3:GetObjectVersion\\\",\\\"s3:GetObjectACL\\\"],\\\"Resource\\\":\\\"arn:aws:s3:::${!transfer:HomeDirectory}*\\\"},{\\\"Sid\\\":\\\"HomeDirObjectPutAccess\\\",\\\"Effect\\\":\\\"Allow\\\",\\\"Action\\\":[\\\"s3:PutObject\\\",\\\"s3:PutObjectACL\\\"],\\\"Resource\\\":\\\"arn:aws:s3:::${!transfer:HomeDirectory}*\\\"},{\\\"Sid\\\":\\\"HomeDirObjectDeleteAccess\\\",\\\"Effect\\\":\\\"Allow\\\",\\\"Action\\\":[\\\"s3:DeleteObjectVersion\\\",\\\"s3:DeleteObject\\\"],\\\"Resource\\\":\\\"arn:aws:s3:::${!transfer:HomeDirectory}*\\\"}]}\",\"PublicKeys\":[\"ssh-rsa AAAA\"]}", {"Role"=>{"Fn::GetAtt"=>["adminSftpAccessRole", "Arn"]}}]})
      end
